		  ...
		  <div class="col-md-6  col-sm-6">
				<div class="well">
					...
					<dl class="dl-horizontal">
						<p>
						{!! Form::open(array('route' => ['product.add',$order->id],'data-parsley-validate'=>'')) !!}
			...
			<div class="col-md-6  col-sm-6">
				<div class="well">
					<dl class="dl-horizontal">
						...
						<p>
						{!! Form::open(array('route' => ['status.add',$order->id],'data-parsley-validate'=>'')) !!}
					...
					<dl class="dl-horizontal">
						...
						<p>
						{!! Form::open(array('route' => ['coupon.add',$order->id],'data-parsley-validate'=>'')) !!}
